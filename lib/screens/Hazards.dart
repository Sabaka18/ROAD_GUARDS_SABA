...
class _HazardsState extends State<Hazards> {
  ...
  Future<void> loadHazards()async{
    final data=await  get_hazard_info();
    
    setState(() {
      hazardData=data;
      visible = List.filled(hazardData.length, false);
    });
  ...
  Widget build(BuildContext context) {
    ...
    {
    return Scaffold(body: Center(child: Text("Loading categories...")));
    }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                ...List.generate(hazardData.length, (index) {
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      HazradSubproblem(index: index,catindex: hazardData[index]["category_id"],hazardData: hazardData,)));
                        },
                        child: Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Hero(
                                        tag: index, child: SvgPicture.memory(base64Decode(hazardData[index]["icon"]),colorFilter: ColorFilter.mode(AppColors.Primary_Red, BlendMode.srcIn))),
                                  ),
                                ),
                                SizedBox(
                                  width: 10.w,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      languageCode=="en"? hazardData[index]["category_name_en"]: hazardData[index]["category_name_ar"],
                                      style: TextStyle(
                                    ...
                                    Text(
                                      languageCode=="en"? hazardData[index]["detail_en"]: hazardData[index]["detail_ar"],
                                      maxLines: 2,
                                      style: TextStyle(
                                          fontSize: 10.sp,
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    HazradSubproblem(
                                                        index: index,catindex: hazardData[index]["category_id"],hazardData: hazardData,)));
                                      },
                                      child: Icon(
